...
[`gspread`](https://gspread.readthedocs.io/en/latest/) Python API. The module also imports the tools from [`gspread-dataframe`](https://pythonhosted.org/gspread-dataframe/)
